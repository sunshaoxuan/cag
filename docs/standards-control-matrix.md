...
| Reference | Control objective | CAG 0.15.0 evidence | Status |
|---|---|---|---|
...
| ISO/IEC 5259 | Source provenance and measurable data quality | source commit, content hash, source fingerprint, detected encoding, parser evidence, file-level rejection audit, DataQualityMetric | Implemented mapping |
