...
当前版本为 `0.7.2`。本机订阅 Codex、持续会话、企业知识平面、并行 Agent Harness、命令策略、持久化审批和受治理自学习已经形成可运行基础。前端采用 One人事公开网站的高对比橙色、青绿色数据语义、悬浮导航和模块化圆形节点设计语言，并按总览、对话工作台、企业知识、能力治理四个路由组织功能。
